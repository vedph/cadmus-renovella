...
Rename-Item -Path .\Cadmus.Renovella.Services\bin\Debug\net8.0\publish -NewName Cadmus.Renovella.Services
compress-archive -path .\Cadmus.Renovella.Services\bin\Debug\net8.0\Cadmus.Renovella.Services\ -DestinationPath .\Cadmus.Renovella.Services\bin\Debug\net8.0\Cadmus.Renovella.Services.zip -Force
# rename back
Rename-Item -Path .\Cadmus.Renovella.Services\bin\Debug\net8.0\Cadmus.Renovella.Services -NewName publish
